...
class SlackPluginConfig extends PluginConfig {
    ...
    function getOptions() {
        ...
        return array(
            ...
            'suitecrm-api-url'          => new TextboxField(array(
            ...
            'suitecrm-api-id'          => new TextboxField(array(
                'label'         => $__('API ID'),
                'configuration' => array(
                    'size'   => 100,
                    'length' => 200
            ...
            'suitecrm-api-secret'          => new TextboxField(array(
                'label'         => $__('API Secret'),
                'configuration' => array(
                    'size'   => 100,
                    'length' => 200
            ...
            'suitecrm-regex-subject-ignore' => new TextboxField([
